...
Компания, занимающаяся авиасообщениями расширила свой бизнес на международные авиаперелёты. Старая система использовала класс **InternalAirFlight**, где указывалась единственная страна - Россия. В новом классе **AirFlight** учитываются две страны - страна отправления и страна назначения. Адаптер **InternalAirFlightAdapter** адаптирует класс внутренних перелётов на расширенный класс **AirFlight**.
